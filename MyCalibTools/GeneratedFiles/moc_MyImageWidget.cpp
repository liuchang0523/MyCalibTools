...
const QMetaObject MyImageWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyImageWidget.data,
      qt_meta_data_MyImageWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MyImageWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyImageWidget.stringdata0))
        return static_cast<void*>(const_cast< MyImageWidget*>(this));
